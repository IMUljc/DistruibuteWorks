...
$(document).ready(
	  ...
	  var mlcid="${mlcid}";
	  var mlcname="${mlcname}";
	  var mlcproname="${mlcproname}";
	  var mlcplace="${mlcplace}";
	  var mlcpronum="${mlcpronum}";
	  var mlctype="${mlctype}";
	  var mlcbtime="${mlcbtime}";
	  var mlcetime="${mlcetime}";
	  var mlcprerson="${mlcprerson}";
	  var mlcrmark="${mlcrmark}";
	  var mlcway="${mlcway}";
	   $("#Mlcid").val(mlcid);
	   $("#Mlcname").val(mlcname);
	   $("#Mlcproname").val(mlcproname);
	   $("#Mlcplace").val(mlcplace);
	   $("#Mlcpronum").val(mlcpronum);
	   $("#Mlctype").val(mlctype);
	   $("#Mlcbtime").val(mlcbtime);
	   $("#Mlcetime").val(mlcetime);
	   $("#Mlcprerson").val(mlcprerson);
	   $("#Mlcramrk").val(mlcrmark);
	   $("#Mlcway").val(mlcway);
							...
							<form id="checkform" data-brackets-id="535" class="form-horizontal adminex-form"
								...
								<div data-brackets-id="640" class="form-group">
									...
									<div data-brackets-id="642" class="col-lg-10">
										<select data-brackets-id="643" class="form-control m-bot15" name="Mlctype" id="123">
								...
								<div class="form-group">
									...
									<div class="col-md-4 col-xs-11">
										...
										<div data-date-viewmode="years" data-date-format="dd-mm-yyyy"
											...
											<input type="text"   size="16" name="Mlcbtime" id="Mlcbtime"
									...
									<div class="col-md-4 col-xs-11">
										...
										<div data-date-viewmode="years" data-date-format="dd-mm-yyyy"
											data-date="12-02-2012" class="input-append date dpYears">
											<input type="text" size="16" name="Mlcetime" id="Mlcetime"
												class="form-control"> <span
												class="input-group-btn add-on">
												<button class="btn btn-primary" type="button">
													<i class="fa fa-calendar"></i>
								...
								<div data-brackets-id="640" class="form-group">
									...
									<div data-brackets-id="642" class="col-lg-10">
										<select data-brackets-id="643" class="form-control m-bot15" name="Mlcperson" id="456">
