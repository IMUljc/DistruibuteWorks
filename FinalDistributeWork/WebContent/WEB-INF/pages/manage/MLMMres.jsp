	...
	<section>
		...
		<div class="main-content">
            ...
            <div data-brackets-id="534" class="panel-body">
                ...
                <form data-brackets-id="535" class="form-horizontal adminex-form" method="post" action=" <c:url value="/maintance/finshMM.html"/> " enctype="multipart/form-data">
                     <div data-brackets-id="561" class="form-group">
                        ...
                        <div data-brackets-id="563" class="col-sm-10">
                            <input data-brackets-id="564" class="form-control"  type="text"  id="mmid" name="mmid"> 
                        </div>
                    </div>  
