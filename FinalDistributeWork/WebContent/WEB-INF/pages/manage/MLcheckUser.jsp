                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <c:forEach items="${mlcklist}" var="mlcheck">
                            <tr>
								<td></td>
							    <td><a href="<c:url value= "/mlcmanagement/getMlcheck.html?Mlcid=${mlcheck.mlcid}"/> ">${mlcheck.mlcid}</a></td>
                                <td>${mlcheck.mlcname}</td>
                                <td>
                                <a href="/FinalDistributeWork/mlcmanagement/tomlcresAdd.html?Mlcid=${mlcheck.mlcid}">
								<button class="btn btn-default" type="button" >执行检测计划</button>
								</a>
								</td>	
                            </tr>
                            </c:forEach>
