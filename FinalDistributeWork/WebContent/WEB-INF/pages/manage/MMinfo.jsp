                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
								<td></td>
							    <td><a href="<c:url value= "/maintance/MMindetail.html?mmid=${mmlist.conserveId}"/> ">${mmlist.conserveId}</a></td>
                                <td>${mmlist.conserveName}</td>
                                <td>
                                <a href="<c:url value= "/maintance/tofinshMM.html?mmid=${mmlist.conserveId}"/> ">
