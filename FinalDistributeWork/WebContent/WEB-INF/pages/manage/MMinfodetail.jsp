...
$(document).ready(
	  ...
	  var mmid="${mmid}";
	  var mmname="${mmname}";
	  var mmproname="${mmproname}";
	  var mmplace="${mmplace}";
	  var mmpronum="${mmpronum}";
	  var mmtype="${mmtype}";
	  var mmbtime="${mmbtime}";
	  var mmetime="${mmetime}";
	  var mmprerson="${mmprerson}";
	  var mmway="${mmway}";
      var mmres="${mmres}";
	   $("#mmid").val(mmid);
	   $("#mmname").val(mmname);
	   $("#mmproname").val(mmproname);
	   $("#mmplace").val(mmplace);
	   $("#mmpronum").val(mmpronum);
	   $("#mmtype").val(mmtype);
	   $("#mmbtime").val(mmbtime);
	   $("#mmetime").val(mmetime);
	   $("#mmprerson").val(mmprerson);
	   $("#mmway").val(mmway);
	   $("#mmres").val(mmres);
		...
		{
			document.getElementById("123").options[2].selected = true;
		}
		else 
			{
			document.getElementById("123").options[3].selected = true;
			} 
	...
	<section>
		...
		<div class="main-content">
            ...
            <div data-brackets-id="534" class="panel-body">
                ...
                <form data-brackets-id="535" class="form-horizontal adminex-form" method="post" action=" <c:url value="/maintance/addMM.html"/> " enctype="multipart/form-data">
                     <div data-brackets-id="561" class="form-group">
                        <label data-brackets-id="562" class="col-sm-2 col-sm-2 control-label">养护单号</label>
                        <div data-brackets-id="563" class="col-sm-10">
                            <input data-brackets-id="564" class="form-control"  type="text" placeholder="该处由系统生成" id="mmid" name="mmid"> 
                        </div>
                    </div>
                    
                    <div data-brackets-id="536" class="form-group">
                        <label data-brackets-id="537" class="col-sm-2 col-sm-2 control-label">养护单名称</label>
                        <div data-brackets-id="538" class="col-sm-10">
                            <input data-brackets-id="539" type="text" class="form-control" id="mmname" name="mmname">
                    ...
                    <div data-brackets-id="536" class="form-group">
                        <label data-brackets-id="537" class="col-sm-2 col-sm-2 control-label">器械名称</label>
                        <div data-brackets-id="538" class="col-sm-4">
                            <input data-brackets-id="539" type="text" class="form-control" id="mmproname" name="mmproname">
                        </div>
                        
                         <label data-brackets-id="550" class="col-sm-2 col-sm-2 control-label">仓库位置</label>
                        <div data-brackets-id="551" class="col-sm-4">
                            <input data-brackets-id="552" type="text" class="form-control tooltips" data-trigger="hover" data-toggle="tooltip" title="" placeholder="" data-original-title="仓库123其中之一" id="mmplace" name="mmplace">
                        </div>
                        
                    </div>
                    
                    <div data-brackets-id="536" class="form-group">
                        <label data-brackets-id="537" class="col-sm-2 col-sm-2 control-label">器械数量</label>
                        <div data-brackets-id="538" class="col-sm-10">
                            <input data-brackets-id="539" type="text" class="form-control round-input" id="mmpronum" name="mmnum">
                            <span data-brackets-id="544" class="help-block">请填写具体数量，整数</span>
                        </div>
                    ...
                    <div data-brackets-id="640" class="form-group">
                        <label data-brackets-id="641" class="col-sm-2 control-label col-lg-2" for="inputSuccess">养护类型</label>
                        <div data-brackets-id="642" class="col-lg-10">
                            <select data-brackets-id="643" class="form-control m-bot15" name="mmtype" id="123">
                                <option data-brackets-id="644" id="mmtype1" value=1>温度计量</option>
                                <option data-brackets-id="645" id="mmtype2" value=2>精度调校</option>
                                <option data-brackets-id="646" id="mmtype3" value=3>湿度计量</option>
                                <option data-brackets-id="647" id="mmtype4"  value=4>装置清洁</option>
                     ...
                     <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-xs-11">
                                        ...
                                        <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="12-02-2012"  class="input-append date dpYears">
                                            <input type="text" readonly="" value="12-02-2012" size="16" class="form-control" id="mmbtime" name="mmbtime"> 
                          ...
                          <label class="control-label col-md-2">预定結束日期</label>
                                    <div class="col-md-4 col-xs-11">
                                        ...
                                        <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="12-02-2012"  class="input-append date dpYears">
                                            <input type="text" readonly="" value="12-02-2012" size="16" class="form-control" id="mmetime" name="mmetime">
                                                          <span class="input-group-btn add-on">
                                                            <button class="btn btn-primary" type="button"><i class="fa fa-calendar"></i></button>
                                                          </span>
                                        </div>
                    ...
                    <div data-brackets-id="640" class="form-group">
                        <label data-brackets-id="641" class="col-sm-2 control-label col-lg-2" for="inputSuccess">养护人员</label>
                        <div data-brackets-id="642" class="col-lg-10">
                            <select data-brackets-id="643" class="form-control m-bot15" name="mmperson"  id="456">
                                <option data-brackets-id="644" id="mmperson1"  value="唐朝1">唐朝</option>
                                <option data-brackets-id="645" id="mmperson2"  value="唐朝2">唐朝2</option>
                                <option data-brackets-id="646" id="mmperson3"  value="唐朝3">唐朝3</option>
                                <option data-brackets-id="647" id="mmperson4"  value="唐朝4">唐朝4</option>
								...
								<div data-brackets-id="783" class="panel-body">
										...
										<div data-brackets-id="785" class="form-group">
											...
											<div data-brackets-id="787" class="col-sm-10">
												<textarea data-brackets-id="788" rows="6" name="mmway" id="mmway" 
                    ...
                    <header data-brackets-id="782" class="panel-heading">
								...
								<div data-brackets-id="783" class="panel-body">
										...
										<div data-brackets-id="785" class="form-group">
											<label data-brackets-id="786" class="col-sm-2 control-label">请尽可能详细</label>
											<div data-brackets-id="787" class="col-sm-10">
												<textarea data-brackets-id="788" rows="6" name="mmres" id="mmres" 
													class="form-control"></textarea>
											</div>
										</div>
