...
<script>
 $(document).ready(
		 function(){
			  ...
			  var mlcid="${Mlcsluid}";
			  var mlcname="${Mlcsluname}";
			  var mlcproname="${Mlcsluproname}";
			  var mlcplace="${Mlcsluprounm}";
			  var mlcpronum="${Mlcsluprounm}";
			  var mlcprerson="${Mlcsluperson}";
			  var mlcway="${Mlcsludetail}";
			   $("#Mlcsluid").val(mlcid);
			   $("#Mlcsluname").val(mlcname);
			   $("#Mlcsluproname").val(mlcproname);
			   $("#Mlcsluprounm").val(mlcpronum);
			   $("#Mlcsluperson").val(mlcprerson);
			   $("#Mlcsludetail").val(mlcway);
					...
					<section data-brackets-id="532" class="panel">
						...
						<div data-brackets-id="534" class="panel-body">
							...
							<form id="checkform" data-brackets-id="535" class="form-horizontal adminex-form"
								method="post" action="<c:url value="/mlcmanagement/addSloution"/>" enctype="multipart/form-data" >
								<div data-brackets-id="561" class="form-group">
									<label data-brackets-id="562"
										class="col-sm-2 col-sm-2 control-label">解决方案单号</label>
									...
									<!-- 在type后面有一个 placeholder="该处由系统生成disabled="" -->
										<input data-brackets-id="564" class="form-control"
											id="Mlcsluid" name="Mlcsluid" type="text" 
											>
									</div>
								</div>
								...
								<div data-brackets-id="536" class="form-group">
									<label data-brackets-id="537"
										class="col-sm-2 col-sm-2 control-label">解决方案名称</label>
									<div data-brackets-id="538" class="col-sm-10">
										<input data-brackets-id="539" type="text" class="form-control"id="Mlcsluname" name="Mlcsluname">
								...
								<div data-brackets-id="536" class="form-group">
									<label data-brackets-id="537"
										class="col-sm-2 col-sm-2 control-label">配件材料名称</label>
									<div data-brackets-id="538" class="col-sm-4">
										<input data-brackets-id="539" type="text" class="form-control" id="Mlcsluproname" name="Mlcsluproname">
									</div>
								...
								<div data-brackets-id="536" class="form-group">
									<label data-brackets-id="537"
										class="col-sm-2 col-sm-2 control-label">配件材料数量</label>
									<div data-brackets-id="538" class="col-sm-10">
										<input data-brackets-id="539" type="text" id="Mlcsluprounm" name="Mlcsluprounm"
								...
								<div data-brackets-id="640" class="form-group">
									<label data-brackets-id="641"
										class="col-sm-2 control-label col-lg-2" for="inputSuccess">解决人员</label>
									<div data-brackets-id="642" class="col-lg-10">
										<select data-brackets-id="643" class="form-control m-bot15" name="Mlcsluperson" id="456">
											<option data-brackets-id="644"  id="Mlcsluperson1" value="唐朝1">唐朝</option>
											<option data-brackets-id="645"  id="Mlcsluperson2" value="唐朝2">唐朝2</option>
											<option data-brackets-id="646"  id="Mlcsluperson3" value="唐朝3">唐朝3</option>
											<option data-brackets-id="647"  id="Mlcsluperson4" value="唐朝4">唐朝4</option>
								...
								<div data-brackets-id="783" class="panel-body">
										...
										<div data-brackets-id="785" class="form-group">
											...
											<div data-brackets-id="787" class="col-sm-10">
												<textarea data-brackets-id="788" rows="6" name="Mlcsludetail" id="Mlcsludetail" 
