                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <c:forEach items="${slulist}" var="slu">
                            <tr>
								<td></td>
							    <td><a href="<c:url value= "/mlcmanagement/getMlcslu.html?Mlsluid=${slu.solutionId}"/> ">${slu.solutionId}</a></td>
                                <td>${slu.solutionName}</td>
                                <td>
                                <a href="/FinalDistributeWork/mlcmanagement/approve.html?sluid=${slu.solutionId}">
								<button class="btn btn-default" type="button" >批准申请</button>
								</a>
								</td>	
                            </tr>
                            </c:forEach>
