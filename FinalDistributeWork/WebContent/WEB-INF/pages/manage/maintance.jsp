...
<script>
 $(document).ready(
		 function(){
	   var mlcid="MMT"+getNowFormatDate();
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list"><a href=""><i class="fa fa-laptop"></i> <span>养护设置</span></a>
                    <ul class="sub-menu-list">
                        <li>s<a href="blank_page.html"> 发起养护计划</a></li>
            ...
            <div data-brackets-id="534" class="panel-body">
                ...
                <form data-brackets-id="535" class="form-horizontal adminex-form" method="post" action=" <c:url value="/maintance/addMM.html"/> " enctype="multipart/form-data">
                    ...
                    <div data-brackets-id="536" class="form-group">
                        ...
                        <div data-brackets-id="538" class="col-sm-10">
                            <input data-brackets-id="539" type="text" class="form-control round-input" id="mmnum" name="mmnum">
                    ...
                    <div data-brackets-id="640" class="form-group">
                        ...
                        <div data-brackets-id="642" class="col-lg-10">
                            <select data-brackets-id="643" class="form-control m-bot15" name="mmtype">
                    ...
                    <div data-brackets-id="640" class="form-group">
                        ...
                        <div data-brackets-id="642" class="col-lg-10">
                            <select data-brackets-id="643" class="form-control m-bot15" name="mmperson" >
