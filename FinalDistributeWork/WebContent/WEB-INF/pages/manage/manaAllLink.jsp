                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <c:forEach items="${MALLlink}" var="mlclink">
                            <tr>
								<td></td>
							    <td><a href=" <c:url value= "/mlcmanagement/getMlcheck.html?Mlcid=${mlclink.mlcid}"/>">${mlclink.mlcid}</a></td>
                                <td><a href="<c:url value= "/mlcmanagement/getMlcres.html?Mlcesid=${mlclink.mlcresid}"/>">${mlclink.mlcresid}</a></td>
                                <td><a href=" <c:url value= "/mlcmanagement/getMlcslu.html?Mlsluid=${mlclink.mlcslutionid}"/>">${mlclink.mlcslutionid}</a></td>
                                <td><a href=" <c:url value= "/mlcmanagement/getRepair.html?Mlcrpid=${mlclink.mlcrqid}"/>">${mlclink.mlcrqid}</a></td>
                                <td>${mlclink.mlcprocess}</td>	
                            </tr>
                            </c:forEach>
