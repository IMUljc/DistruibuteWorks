                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <c:forEach items="${Mlink}" var="mlclink">
                            <tr>
								<td></td>
                                ...
                                <td>
                                <a href="  <c:url value= "/mlcmanagement/tomlcslu.html?Mlcid=${mlclink.mlcid}"/> ">
                               
								<button class="btn btn-default" type="button" >填写解决方案</button>
								</a>
								</td>	
                            </tr>
                            </c:forEach>
